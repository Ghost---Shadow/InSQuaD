...
# python -m unittest subset_selection_strategies.diversity_test.TestDiversitySubsetSelectionStrategy -v
class TestDiversitySubsetSelectionStrategy(unittest.TestCase):
    # python -m unittest subset_selection_strategies.diversity_test.TestDiversitySubsetSelectionStrategy.test_subset_select -v
    def test_subset_select(self):
        config = Config.from_file("experiments/tests/diversity_test_experiment.yaml")
    ...
    # python -m unittest subset_selection_strategies.diversity_test.TestDiversitySubsetSelectionStrategy.test_real_data -v
    ...
    # python -m unittest subset_selection_strategies.diversity_test.TestDiversitySubsetSelectionStrategy.test_shorter_than_budget -v
    def test_shorter_than_budget(self):
        ...
        strategy = DiversitySubsetSelectionStrategy(config, pipeline)
    ...
    # python -m unittest subset_selection_strategies.diversity_test.TestDiversitySubsetSelectionStrategy.test_empty_shortlist -v
