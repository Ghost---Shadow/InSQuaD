...
# python -m unittest shortlist_strategies.quaild_similar_strategy_test.QuaildSimilarStrategy -v
class QuaildSimilarStrategy(unittest.TestCase):
    # python -m unittest shortlist_strategies.quaild_similar_strategy_test.QuaildSimilarStrategy.test_shortlist -v
    def test_shortlist(self):
        config = Config.from_file("experiments/tests/quaild_test_similar.yaml")
    ...
    # python -m unittest shortlist_strategies.quaild_similar_strategy_test.QuaildSimilarStrategy.test_assemble_few_shot -v
