python src/offline_eval.py --config=experiments/in_paper/fastvotek_mpnet_stablelm.yaml
python src/offline_eval.py --config=experiments/in_paper/ideal_mpnet_stablelm.yaml
...
python src/offline_eval.py --config=experiments/in_paper/votek_mpnet_stablelm.yaml
