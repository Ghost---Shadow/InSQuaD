python src/train.py --config=experiments/tests/fastvotek_test_experiment.yaml
python src/train.py --config=experiments/tests/ideal_test_experiment.yaml
python src/train.py --config=experiments/tests/leastconfidence_test_experiment.yaml
