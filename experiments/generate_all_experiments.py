...
def generate_shell_scripts(root_dir):
    ...
    with open("./experiments/all.sh", "w") as all_script:
            ...
            if yaml_files:
                ...
                with open(train_script_path, "w") as train_script, open(
                    ...
                    for yaml_file in sorted(yaml_files):
                        ...
                        if "gemma" in eval_command:
                            all_script.write(eval_command)
                            all_script.write(UPLOAD_ARTIFACTS)
